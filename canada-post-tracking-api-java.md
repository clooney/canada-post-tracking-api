Canada Post Tracking API - Java
================================
Use Java to track Canada Post shipments with Canada Post Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.canadapost;
    ...
    public class CreateCanadaPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setCourierCode("canada-post");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateCanadaPostTrackingsExample {
...
Get status of the shipment:
    ...
    public class GetCanadaPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                trackingParams.setCourierCode("canada-post");
...
Update a tracking by ID:
    ...
    public class UpdateCanadaPostTrackingExample {
