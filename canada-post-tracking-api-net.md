Canada Post Tracking API - .Net
================================
Use .Net to track Canada Post shipments with Canada Post Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.courierCode = "canada-post";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  getTrackingResultsParams.courierCode = "canada-post";
